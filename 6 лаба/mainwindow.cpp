...
void Temperature::getCurrentTemperature() {
    ...
    QNetworkRequest request(QUrl("http://localhost:8000/current_temperature"));
...
void Temperature::getTemperatureRange(QDateTime start, QDateTime finish) {
    ...
    QUrl url = QUrl("http://localhost:8000/get_filter_records");
...
MainWindow::MainWindow(QWidget *parent)
    ...
    ui->startDateTimeRange->setDisplayFormat(QString("yyyy-MM-dd hh:mm:ss"));
